        ...
        <div style={s.cards}>
          ...
          {[
            ...
            },
            {
              ...
              desc: 'Stress signature detected in rhythm. Ghost session loads. Real account locks silently. Blockchain records the attack.',
            ...
            <div
              ...
              style={s.card}
              onMouseEnter={e =>
                e.currentTarget.style.boxShadow = "0 0 50px rgba(0,255,136,0.25)"
              }
              onMouseLeave={e =>
                e.currentTarget.style.boxShadow = "0 0 40px rgba(0,255,136,0.08)"
              }
            >

              <div style={s.cardTopEdge} />

              <div style={{ color: '#00ff88', fontSize: 20, marginBottom: 12 }}>
                ⬡
              </div>
              ...
              <div style={{ ...s.cardTag, color: card.tagColor }}>
                {card.tag}
              </div>
    ...
    for (let i = 0; i < particles.length; i++) {
      ...
      for (let j = i + 1; j < particles.length; j++) {
        ...
        if (dist < 140) {
          ...
          ctx.strokeStyle =
            `rgba(0,255,136,${0.07 * (1 - dist / 140)})`;
